...
class SILab2Test {
    ...
    void checkEveryBranch() {
        ...
        exception = assertThrows(RuntimeException.class, () -> SILab2.checkCart(items(new Item("Nina", "02a3456", 500, 0.4f)), 1));
        assertTrue(exception.getMessage().contains("Invalid character in item barcode!"));

        //7 allItems=[{"Dimitar",123456,200,-1}],payment=any
        assertFalse(SILab2.checkCart(items(new Item("Nina", "123456", 200, -1)), 2));
    }
